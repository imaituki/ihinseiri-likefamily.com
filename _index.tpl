...
<div id="body">
	<div id="main_visual">
		<div class="sp_none"><img src="/common/image/contents/top/main.jpg" alt=""></div>
    <div class="pc_none"><img src="/common/image/contents/top/main_sp.jpg" alt=""></div>
	</div>
	<section>
		<div id="top_about">
	...
	<section>
		<div id="top_advice">
			<div class="center wrapper">
				<p class="person"><img src="/common/image/contents/top/adviser.png" alt=""></p>
	...
	<section>
		<div id="top_reason"  class="bg_lye">
					...
					<div class="row">
						<div class="col-xs-6 mb30">
							<div class="reason height-1">
								<div class="img"><img src="/common/image/contents/top/reason1.jpg" alt=""></div>
								<h3>清潔な服</h3>
						...
						<div class="col-xs-6 mb30">
							<div class="reason height-1">
								<div class="img"><img src="/common/image/contents/top/reason2.jpg" alt=""></div>
								<h3>わかりやすい料金体系</h3>
						...
						<div class="col-xs-6 mb30">
							<div class="reason height-1">
								<div class="img"><img src="/common/image/contents/top/reason3.jpg" alt=""></div>
								<h3>無料お見積り</h3>
						...
						<div class="col-xs-6 mb30">
							<div class="reason height-1">
								<div class="img"><img src="/common/image/contents/top/reason4.jpg" alt=""></div>
								<h3>作業完了報告書</h3>
            ...
            <div class="col-xs-6 mb30">
              <div class="reason height-1">
                <div class="img"><img src="/common/image/contents/top/reason6.jpg" alt=""></div>
                <h3>こまめな連絡</h3>
                <p>「これは処分してはいけない必要なものでは？」と気づいた遺品が見つかったときなど、すぐにご依頼主様にご連絡いたします。</p>
						...
						<div class="col-xs-6 mb30">
							<div class="reason height-1">
								<div class="img"><img src="/common/image/contents/top/reason5.jpg" alt=""></div>
								<h3>アフターフォローの充実</h3>
		...
		<div id="top_trouble">
			<div class="center wrapper-t">
				<div class="row no-gutters">
					<div class="col-sm-7 height-1 disp_tbl2">
						<div class="disp_td">
							<h3 class="mb30">こんな<span>お悩み</span>ありませんか。</h3>
							<ul>
			                    <li class="mb20 fa_b">
					...
					<div class="col-sm-5 height-1 disp_tbl2 sp_none">
						<div class="flex height-1">
							<p class="pos_ar"><img src="/common/image/contents/top/trouble.png" alt=""></p>
						</div>
					</div>
				</div>
			</div>
			<div class="hl">こんなお悩みでお困りの方は<span>ライクファミリー</span>にご相談ください！</div>
		</div>
	</section>
	<section>
		<div id="top_price"  class="bg_lye">
			<div class="center wrapper">
				<h2 class="hl_1">PRICE<span>料金</span></h2>
				<div class="row mb30">
					<div class="col-xs-5 col-xs-push-7 disp_tbl2 height-1">
						<div class="disp_td">
							<div class="img pos_ac"><img src="/common/image/contents/top/price.png" alt=""></div>
						</div>
					</div>
				...
				<h2 class="hl_2 mb30"><span>料金例</span></h2>
				<div class="unit mb30">
					...
					<div class="row">
						<div class="col-md-3 height-1 disp_tbl2 floor">
							<div class="disp_td">
								<div class="pos_ac"><img src="/common/image/contents/top/floor_1.jpg" alt=""></div>
							</div>
						</div>
						<div class="col-md-9 height-1">
							<div class="flex_c">
								<div class="height-1r_all volume box">
									<h4>お荷物量</h4>
									<div class="pd">
										<p><img src="/common/image/contents/top/truck1.jpg" alt=""></p>
										<p>軽トラック</p>
								...
								<div class="height-1r_all people box">
									<h4>作業人数/時間</h4>
									<div class="pd">
										<p><img src="/common/image/contents/top/1people.jpg" alt=""></p>
										<p>人件費1人</p>
				...
				<div class="unit mb30">
					...
					<div class="row">
						<div class="col-md-3 height-1 disp_tbl2 floor">
							<div class="disp_td">
								<div class="pos_ac"><img src="/common/image/contents/top/floor_2.jpg" alt=""></div>
							</div>
						</div>
						<div class="col-md-9 height-1">
							<div class="flex_c">
								<div class="height-1r_all volume box">
									<h4>お荷物量</h4>
									<div class="pd">
										<p><img src="/common/image/contents/top/truck2.jpg" alt=""></p>
										<p>2ｔトラック</p>
								...
								<div class="height-1r_all people box">
									<h4>作業人数/時間</h4>
									<div class="pd">
										<p><img src="/common/image/contents/top/3people.jpg" alt=""></p>
										<p>人件費3人</p>
				...
				<div class="unit mb30">
					...
					<div class="row">
						<div class="col-md-3 height-1 disp_tbl2 floor">
							<div class="disp_td">
								<div class="pos_ac"><img src="/common/image/contents/top/floor_3.jpg" alt=""></div>
							</div>
						</div>
						<div class="col-md-9 height-1">
							<div class="flex_c">
								<div class="height-1r_all volume box">
									<h4>お荷物量</h4>
									<div class="pd">
										<p><img src="/common/image/contents/top/truck3.jpg" alt=""></p>
										<p>2tトラック+軽トラック</p>
								...
								<div class="height-1r_all people box">
									<h4>作業人数/時間</h4>
									<div class="pd">
										<p><img src="/common/image/contents/top/5people.jpg" alt=""></p>
										<p>作業員5人</p>
        ...
        <div class="unit mb30">
          ...
          <div class="row">
            <div class="col-md-3 height-1 disp_tbl2 floor">
              <div class="disp_td">
                <div class="pos_ac"><img src="/common/image/contents/top/floor_4.jpg" alt=""></div>
              </div>
            </div>
            <div class="col-md-9 height-1">
              <div class="flex_c">
                <div class="height-1r_all volume box">
                  <h4>お荷物量</h4>
                  <div class="pd">
                    <p><img src="/common/image/contents/top/truck4.jpg" alt=""></p>
                    <p>4tトラック</p>
                ...
                <div class="height-1r_all people box">
                  <h4>作業人数/時間</h4>
                  <div class="pd">
                    <p><img src="/common/image/contents/top/6people.jpg" alt=""></p>
                    <p>作業員6人</p>
				...
				<div class="pay_way">
					<p class="pos_ac"><img src="/common/image/foot/pay.jpg" alt=""></p>
				</div>
			</div>
		</div>
	</section>
	<section>
		<div id="top_flow">
			<div class="center wrapper">
				<h2 class="hl_1">FLOW<span>ご利用の流れ</span></h2>
				<div class="flex_c mb30">
					<div class="flow">
						<div class="pos_ac img">
							<img src="/common/image/contents/top/flow1.jpg" alt="">
					...
					<div class="arrow">
						...
						<i class="fas fa-caret-down pc_none"></i>
					</div>
					<div class="flow">
						<div class="pos_ac img">
							<img src="/common/image/contents/top/flow2.jpg" alt="">
					...
					<div class="flow">
						<div class="pos_ac img">
							<img src="/common/image/contents/top/flow3.jpg" alt="">
					...
					<div class="flow">
						<div class="pos_ac img">
							<img src="/common/image/contents/top/flow4.jpg" alt="">
		...
		<div id="top_voice" class="bg_lye">
			<div class="center wrapper">
                ...
                <div id="voice_slide">
                    <div class="unit">
                        <div class="row mini">
                            <div class="col-md-6 height-1 spmb">
                                <p class="flex"><span class="name">M.K様</span><span class="cat">遺品整理</span></p>
                            </div>
                            <div class="col-md-6 height-1 disp_tbl2">
                                <div class="disp_td star">
                        ...
                        <h4 class="mb10">問い合わせて3日後の片付けに満足です</h4>
                        <p>住んでいた場所から急いで退去しなければならない事情が出来てしまい困っていました。急な作業の依頼だったにも関わらず、気持ちよく作業してもらえて満足しています。自分だけではとてもじゃないけど片付けられない…</p>
                    </div>
                    <div class="unit">
                        <div class="row mini">
                            <div class="col-md-6 height-1 spmb">
	...
	<section>
		<div id="top_area">
			<div class="center wrapper">
                <div class="area">
                    <h2 class="hl_4 mb50"><span class="main">サービス対応エリア</span></h2>
                    <div class="row">
                        <div class="col-xs-4 height-1 disp_tbl2">
                            <div class="disp_td">
                                <img src="/common/image/contents/top/area.jpg" alt="">
                            </div>
                        </div>
                            ...
                            <div class="disp_td">
                                <div class="row">
                                    <div class="col-xs-6 pre">
                                        <p class="pos_ac">岡山県</p>
                                    </div>
                                    <div class="col-xs-6 pre">
                                        <p class="pos_ac">香川県</p>
                                    </div>
                                    <div class="col-xs-6 pre">
                                        <p class="pos_ac">広島県</p>
                                    </div>
                                    <div class="col-xs-6 pre">
                                        <p class="pos_ac">兵庫県</p>
                                    </div>
                                </div>
                                <p>※上記のほか、渡船が必要な地域（離島）等一部地域でご利用いただけない場合がございます。</p>
                            </div>
                        </div>
                    </div>
                </div>
	...
	<section>
		<div id="top_works" class="bg_lor">
			<div class="center wrapper">
                ...
                <div class="row mb50">
                	{foreach from=$t_work item="work" name="loopWork"}
                    <div class="col-sm-4 mb20">
                        <div class="unit height-1">
                            <p class="cat">作業実績</p>
                            <div class="img"><div class="img_rect"><img src="{if !empty( $work.image1 )}{$_IMAGEPATH}/work/image1/l_{$work.image1}{else}/common/image/contents/top/service1.jpg{/if}" alt="{$work.image1_caption|default:$work.title}"></div></div>
                            <p class="date">{$work.date|date_format:"%Y.%m.%d"}</p>
	...
	<section>
		<div id="top_news">
			<div class="center wrapper">
				<h2 class="hl_1">NEWS<span>お知らせ</span></h2>
                <div class="info_list mb50">
                	{foreach from=$t_information item="info" name="loopInfo"}
					<dl>
						<dt><span class="cat">{$OptionInfoCategory[$info.id_category]}</span><span>{$info.date|date_format:"%Y.%m.%d"}</span></dt>
						<dd><a href="/news/detail.php?id={$info.id_information}">{$info.title}</a></dd>
					</dl>
					{foreachelse}
					<dl>
