...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="{$_ADMIN.home}/common/js/colorbox/colorbox.css" />
		{include file=$template_javascript}
		<script src="{$_ADMIN.home}/common/js/colorbox/jquery.colorbox-min.js"></script>
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<div class="input-daterange input-group" id="datepicker">
											...
											<input type="text" class="input-sm form-control datepicker" name="search_date_start" id="search_date_start" value="{$_SESSION.admin.$_CONTENTS_DIR.search.POST.search_date_start|default:""}" readonly>
											<span class="input-group-addon">～</span>
											<input type="text" class="input-sm form-control datepicker" name="search_date_end" id="search_date_end"  value="{$_SESSION.admin.$_CONTENTS_DIR.search.POST.search_date_end|default:""}" readonly>
										</div>
									</div>
								</div>
								<div class="col-sm-3">
									<div class="form-group">
										...
										<select name="search_category" class="form-control">
											...
											{html_options options=$OptionInfoCategory selected=$_SESSION.admin.$_CONTENTS_DIR.search.POST.search_category|default:""}
										</select>
									</div>
								</div>
								<div class="col-sm-4">
